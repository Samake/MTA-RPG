...
function objectPreview:create(element,rotX,rotY,rotZ,projPosX,projPosY,projSizeX,projSizeY,isRelative,postGui,isSRT)
	...
	if new.isSecondRT then
		...
		new.shader = dxCreateShader("client/external/objectPreview/fx/fx_pre_"..elementType..".fx", 0, 0, false, "all")
		...
		new.shader = dxCreateShader("client/external/objectPreview/fx/fx_pre_"..elementType.."_noMRT.fx", 0, 0, false, "all")	
	end
